...
define('LIFE_REVOLUTION_FAMILY_VERSION', '0.1.0');
...
function life_revolution_family_render_page(): void {
    ...
    <div class="wrap lrf-wrap">
        ...
        <?php if (count($member_ids) < 2) : ?>
            <div class="lrf-notice"><?php esc_html_e('現在は1人分です。下の「夫婦メンバー設定」で奥さまのWordPressアカウントを選ぶと合算が始まります。', 'life-revolution-family'); ?></div>
        <?php endif; ?>
